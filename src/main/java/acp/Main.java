...
import acp.db.DbConn;
import acp.db.DbWork;
import acp.db.HbCritMode;
...
public class Main extends JFrame {
  ...
  public static DbConn dbConn = DbConn.DBCP;
  public static DbWork dbWork = DbWork.DBUTIL;
  public static DbcpMode dbcpMode = DbcpMode.SPOOL_DS;      // for dbWork = DBCP
  public static HbCritMode hbCrit = HbCritMode.ALL_RESTR;   // for dbWork = HB_CRIT
